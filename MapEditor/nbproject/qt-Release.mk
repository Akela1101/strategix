...
# Generated by qmake (2.01a) (Qt 4.5.2) on: ?? ????. 27 19:51:32 2010
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -Inbproject -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Iinclude -Iqtforms -Iqtforms -Iqtforms -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
qtforms/moc_DialogNew.cpp: qtforms/ui_DialogNew.h \
		qtforms/DialogNew.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) qtforms/DialogNew.h -o qtforms/moc_DialogNew.cpp

qtforms/moc_MainForm.cpp: qtforms/ui_MainForm.h \
		qtforms/MainForm.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) qtforms/MainForm.h -o qtforms/moc_MainForm.cpp

qtforms/moc_MapArea.cpp: include/MapArea.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) include/MapArea.h -o qtforms/moc_MapArea.cpp
...
qtforms/ui_DialogNew.h: qtforms/DialogNew.ui
	/usr/bin/uic-qt4 qtforms/DialogNew.ui -o qtforms/ui_DialogNew.h

qtforms/ui_MainForm.h: qtforms/MainForm.ui
	/usr/bin/uic-qt4 qtforms/MainForm.ui -o qtforms/ui_MainForm.h
...
build/Release/GNU-Linux-x86/main.o: src/main.cpp qtforms/MainForm.h \
		qtforms/ui_MainForm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Release/GNU-Linux-x86/main.o src/main.cpp

build/Release/GNU-Linux-x86/MapArea.o: src/MapArea.cpp qtforms/MainForm.h \
		qtforms/ui_MainForm.h \
		qtforms/DialogNew.h \
		qtforms/ui_DialogNew.h
