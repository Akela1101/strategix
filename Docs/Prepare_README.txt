...
3. create empty exe project for Sample1, empty lib project for Strategix. Set the last as dependence of Sample1.
...
7. add to .gitignore all unnecessary files and folders.
